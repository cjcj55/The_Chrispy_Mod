...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    ...
    public AlloyFurnaceMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
        this(windowId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public AlloyFurnaceMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuTypesInit.ALLOY_FURNACE_MENU.get(), windowId);
