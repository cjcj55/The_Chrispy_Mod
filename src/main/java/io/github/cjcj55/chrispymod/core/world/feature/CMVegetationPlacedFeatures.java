...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_STRAWBERRY_BUSH.getHolder().get(),
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BLUEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_LOGANBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_RED_RASPBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BLACK_RASPBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_GOLDEN_RASPBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_WHITE_RASPBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_MARIONBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BLACKCURRANT_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_REDCURRANT_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_HUCKLEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_WINEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_ELDERBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BLACKBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BOYSENBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_GROUND_CHERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_ARONIA_BERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_SERVICEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_WONDERBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_MULBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_LINGONBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_CRANBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_DEWBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_THIMBLEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_GOOSEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_CHOKEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_OLALLIEBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_ACEROLA_CHERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BARBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_BAYBERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
...
//            () -> new PlacedFeature(CMVegetationConfiguredFeatures.PATCH_GOGI_BERRY_BUSH.getHolder().get(),
//                    rareBerryPlacement(128, PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
//
//
//
