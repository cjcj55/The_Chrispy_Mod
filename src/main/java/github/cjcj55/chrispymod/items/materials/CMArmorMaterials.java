...
public enum CMArmorMaterials implements ArmorMaterial {
    /*
    ...
    */
    ...
    private CMArmorMaterials(String name, int durabilityMultiplier, int[] slotsProtection, int enchantmentValue, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
