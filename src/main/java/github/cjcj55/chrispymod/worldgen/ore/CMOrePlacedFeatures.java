...
public class CMOrePlacedFeatures {
    // Overworld Ores
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        // Overworld Ores
        register(context, OVERWORLD_RUBY_ORE_SMALL_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_RUBY_ORE_SMALL_KEY),
        ...
        register(context, OVERWORLD_RUBY_ORE_LARGE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_RUBY_ORE_LARGE_KEY),
        ...
        register(context, OVERWORLD_RUBY_ORE_HIDDEN_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_RUBY_ORE_HIDDEN_KEY),
        ...
        register(context, OVERWORLD_OPAL_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_OPAL_ORE_KEY),
        ...
        register(context, OVERWORLD_OPAL_ORE_SMALL_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_OPAL_ORE_SMALL_KEY),
                CMOrePlacement.commonOrePlacement(10, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(80))));
        register(context, OVERWORLD_TANGERINE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_TANGERINE_ORE_KEY),
        ...
        register(context, OVERWORLD_TANGERINE_ORE_SMALL_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_TANGERINE_ORE_SMALL_KEY),
                CMOrePlacement.commonOrePlacement(7, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(70))));
        register(context, OVERWORLD_COBALT_ORE_SMALL_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_COBALT_ORE_SMALL_KEY),
                CMOrePlacement.commonOrePlacement(6, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
        register(context, OVERWORLD_COBALT_ORE_LARGE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_COBALT_ORE_LARGE_KEY),
        ...
        register(context, OVERWORLD_COBALT_ORE_HIDDEN_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_COBALT_ORE_HIDDEN_KEY),
        ...
        register(context, OVERWORLD_PARYTH_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_PARYTH_ORE_KEY),
        ...
        register(context, OVERWORLD_PARYTH_ORE_SMALL_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_PARYTH_ORE_SMALL_KEY),
                CMOrePlacement.commonOrePlacement(8, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(180))));
        register(context, OVERWORLD_WHITE_DWARF_STAR_ORE_SMALL_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_WHITE_DWARF_STAR_ORE_SMALL_KEY),
                CMOrePlacement.commonOrePlacement(3, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
        register(context, OVERWORLD_WHITE_DWARF_STAR_ORE_HIDDEN_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_WHITE_DWARF_STAR_ORE_HIDDEN_KEY),
        ...
        register(context, OVERWORLD_NATURAL_ESSENCE_ORE_HIDDEN_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_NATURAL_ESSENCE_ORE_HIDDEN_KEY),
                CMOrePlacement.commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32))));
        register(context, OVERWORLD_EXPERIENCE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_EXPERIENCE_ORE_KEY),
                CMOrePlacement.commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.bottom(), VerticalAnchor.top())));
        register(context, OVERWORLD_EXPERIENCE_ORE_HIDDEN_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.OVERWORLD_EXPERIENCE_ORE_HIDDEN_KEY),
                CMOrePlacement.commonOrePlacement(5, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top())));
        // Nether Ores
        register(context, NETHER_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.NETHER_RUBY_ORE_KEY),
                CMOrePlacement.commonOrePlacement(7, PlacementUtils.RANGE_10_10));
        register(context, NETHER_FLAME_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.NETHER_FLAME_ORE_KEY),
                CMOrePlacement.commonOrePlacement(8, PlacementUtils.RANGE_10_10));
        register(context, NETHER_HELLFIRE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMOreConfiguredFeatures.NETHER_HELLFIRE_ORE_KEY),
