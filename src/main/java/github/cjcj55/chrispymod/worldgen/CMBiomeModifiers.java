...
public class CMBiomeModifiers {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_OVERWORLD_RUBY_ORE_SMALL, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                ...
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_RUBY_ORE_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_RUBY_ORE_LARGE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_RUBY_ORE_LARGE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_RUBY_ORE_HIDDEN, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_RUBY_ORE_HIDDEN_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_OVERWORLD_OPAL_ORE_SMALL, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_OPAL_ORE_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_OVERWORLD_TANGERINE_ORE_SMALL, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_TANGERINE_ORE_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_COBALT_ORE_SMALL, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_COBALT_ORE_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_COBALT_ORE_LARGE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_COBALT_ORE_LARGE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_COBALT_ORE_HIDDEN, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_COBALT_ORE_HIDDEN_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_OVERWORLD_PARYTH_ORE_SMALL, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_PARYTH_ORE_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_WHITE_DWARF_STAR_ORE_SMALL, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_WHITE_DWARF_STAR_ORE_SMALL_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_WHITE_DWARF_STAR_ORE_HIDDEN, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_WHITE_DWARF_STAR_ORE_HIDDEN_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_OVERWORLD_NATURAL_ESSENCE_ORE_HIDDEN, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_NATURAL_ESSENCE_ORE_HIDDEN_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        ...
        context.register(ADD_OVERWORLD_EXPERIENCE_ORE_HIDDEN, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(CMPlacedFeatures.OVERWORLD_EXPERIENCE_ORE_HIDDEN_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES));
        // Nether Ores
