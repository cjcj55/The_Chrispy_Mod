...
public class CMPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> OVERWORLD_WHITE_DWARF_STAR_ORE_PLACED_KEY = registerKey("white_dwarf_star_ore_placed");
    public static final ResourceKey<PlacedFeature> OVERWORLD_NATURAL_ESSENCE_ORE_PLACED_KEY = registerKey("natural_essence_ore_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        // Overworld Ores
        register(context, OVERWORLD_RUBY_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMConfiguredFeatures.OVERWORLD_RUBY_ORE_KEY),
                CMOrePlacement.commonOrePlacement(12,
        ...
        register(context, OVERWORLD_TANGERINE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMConfiguredFeatures.OVERWORLD_TANGERINE_ORE_KEY),
                CMOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context, OVERWORLD_COBALT_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMConfiguredFeatures.OVERWORLD_COBALT_ORE_KEY),
                CMOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context, OVERWORLD_PARYTH_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMConfiguredFeatures.OVERWORLD_PARYTH_ORE_KEY),
                CMOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context, OVERWORLD_WHITE_DWARF_STAR_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMConfiguredFeatures.OVERWORLD_WHITE_DWARF_STAR_ORE_KEY),
                CMOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
        register(context, OVERWORLD_NATURAL_ESSENCE_ORE_PLACED_KEY, configuredFeatures.getOrThrow(CMConfiguredFeatures.OVERWORLD_NATURAL_ESSENCE_ORE_KEY),
                CMOrePlacement.commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(80))));
