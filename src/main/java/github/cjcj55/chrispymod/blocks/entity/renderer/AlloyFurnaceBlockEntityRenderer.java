//package github.cjcj55.chrispymod.blocks.entity.renderer;
//
...
//        pPoseStack.mulPose(Axis.YN.rotationDegrees(pBlockEntity.getBlockState().getValue(AlloyFurnaceBlock.FACING).toYRot()));
